...
<hr />
<br />
Security diagnosis is a feature that examines the cloud infrastructure drawn on the canvas 
for potential security issues before final export. 
It helps users identify human errors and vulnerabilities that may pose security risks.
...
Cloud Studio provides six security check items to ensure compliance with security standards.
