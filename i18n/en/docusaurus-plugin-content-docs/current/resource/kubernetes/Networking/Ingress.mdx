...
-   [Ingress(kubernetes)](https://kubernetes.io/en/docs/concepts/services-networking/ingress/)
-   [Ingress(Terraform)](https://registry.terraform.io/providers/hashicorp/kubernetes/latest/en/docs/resources/ingress)
