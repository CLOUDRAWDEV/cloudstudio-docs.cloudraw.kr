...
title: CosmosdbMongo
sidebar_position: 2
tags: [Azure, Resource, Cosmosdb, CosmosdbMongo]
---
...
-   `mongo_collection`
    ...
    -   `ttl_seconds` : The default Time To Live of collection in seconds
    -   `shard_key` : The name of key to partition on for sharding
    -   `throughput` : The throughput of the MongoDB Collection - `400`~ `100000`
    -   `enable_autoscale` : Whether to apply auto scaling to Cassandra keyspace - `true`, `false`
    -   `included_mongo_database_name` : The name of Mongo Database in which the collection is created
