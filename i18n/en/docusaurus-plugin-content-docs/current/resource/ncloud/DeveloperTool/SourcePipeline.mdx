...
-   `trigger_schedule` : Set up a schedule for Pipeline to run automatically
...
-   `trigger_target_sourcecpipeline_id` : Trigger List of pipeline IDs to run automatically when the set pipeline completes execution
...
-   [ncloud_sourcepipeline(Terraform)](https://registry.terraform.io/providers/NaverCloudPlatform/ncloud/latest/en/docs/resources/sourcepipeline_project)
