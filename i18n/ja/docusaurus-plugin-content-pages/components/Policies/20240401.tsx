    ...
    return (
        <>
            <section className={policyStyles.policy}>
                ...
                <br />
                <h4>3. 자격증명 등록시 아래와 같은 개인정보를 수집합니다.</h4>
                <table>
                    <thead>
                        <tr>
                            <th style={{ width: "20%" }}>수집항목</th>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                {" "}
                                MS Azure 서비스 API 연동을 통한 관리 서비스 제공
                            </td>
                            <td rowSpan={3} style={{ textAlign: "center" }}>
                ...
                <h2>개인정보 처리의 위탁</h2>
                <h4>
                    회사는 서비스 제공에 관한 계약을 이행하고 이용자의 편의 증진
                    등을 위하여 개인정보 처리업무를 외부 전문업체에게 위탁하고
                    있으며, 수탁자에 대해서는 “위·수탁계약서” 등을 통하여 관련
                    법규 및 지침의 준수, 정보보호 및 비밀유지, 제3자 제공 금지,
                    사고 시 책임부담, 위탁기간 종료 즉시 개인정보의 반납/파기
                    의무 등 책임에 관한 사항을 규정하고, 수탁자가 개인정보를
                ...
                <h4>
                    ...
                    기타 관련 법령에 의한 정보보호 사유에 따라 일정 기간 저장된
                    후 파기됩니다. 동 개인정보는 법률에 의한 경우가 아니고서는
                ...
                <h4>
                    ...
                    전자거래 기본법, 통신비밀보호법 등 법령에서 일정기간 정보의
                    보관을 규정하는 경우는 아래와 같습니다. 회사는 이 기간 동안
                    법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른
                    목적으로는 절대 이용하지 않습니다.
                    <br />
                    <br />
                ...
                <h4>
                    이용자는 서비스에서 보유하고 있는 자신의 개인정보를 제공할
                    것을 요청할 권리가 있습니다.
                    <br />
                    개인 정보에 접근하려면 “마이페이지”를 클릭하면 개인정보 또는
                    기본 설정을 업데이트 할 수 있습니다.
                    <br />
                    이용자는 자신의 개인정보를 수정, 차단, 완료 및 삭제하고,
                    사용을 제한하고, 데이터를 다른 조직으로 이관하도록 요청할
                    권리가 있습니다.
                    <br />
                    이용자는 자신의 개인정보 처리에 관한 추가 정보를 요청할
                    권리가 있습니다. 또한, 일부 상황에서 서비스의 데이터 처리에
                    이의를 제기할 권리가 있으며 데이터 처리 동의를 요청한 경우
                    동의를 철회할 권리가 있습니다.
                    <br />
                    <br />
                    위에 명시된 권한에 대한 지원을 원하면 아래
                    개인정보담당자(hbmoon@cloudraw.kr)에게 문의해 주시기
                    바랍니다.
                    <br />
                </h4>
                ...
                <h4>
                    ...
                    <br />
                    개인정보 보호책임자의 지정 등 개인정보 보호 조직의 구성 및
                    운영에 관한 사항 등을 포함하여 개인정보 내부관리계획을
                    수립하고, 매 년 내부관리계획을 잘 시행하고 있는지를 점검하고
                    있습니다.
                    <br />
                    <br />
                    2. 개인정보 암호화
                    <br />
                    회사는 비밀번호, 결제수단 등의 개인정보를 법령에서 요구하는
                    기준에 따라 암호화 처리하고 있으며, 중요한 데이터는 파일 및
                    전송 데이터를 암호화하는 등 별도의 보안 조치를 취하여
                    ...
                    누출되거나 손상되지 않도록 방지하고 있으며, 암호화 통신 등을
                    통하여 네트워크상에서 개인정보를 안전하게 전송할 수 있도록
                    하고 있으며 기타 시스템적으로 보안성을 확보하기 위한 가능한
                    모든 기술적 장치를 갖추려 노력하고 있습니다.
                    <br />
                    <br />
                    4. 개인정보보호전담기구의 운영
                    <br />
                    회사는 사내 개인정보보호전담기구 등을 통하여 회사
                    ...
                    개인정보가 유출되어 발생한 문제에 대해 회사는 일체의 책임을
                    지지 않습니다.
                </h4>
