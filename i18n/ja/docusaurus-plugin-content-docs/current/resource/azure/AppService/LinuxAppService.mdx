...
sidebar_position: 0
tags: [Azure, リソース, App Service, Linux, Function App]
---
...
Azure App Service はインフラを管理する必要なく、選択したプログラミング言語でウェブアプリ、モバイルバックエンド、RESTful API をビルドし、ホスティングできる PaaS サービスです。
