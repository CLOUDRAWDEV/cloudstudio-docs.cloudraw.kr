...
> - ```Included Vnet Name```: etchubnetvn
...
> - ```Service Name```: etchubnetng
> - ```Included Subnet Name```: etchubnetvn:GatewaySubnet
> - ```Type```: Vpn
> - ```Vpn Type```: RouteBased
...
> - ```Ip Configuration.Public Ip Name```: gateway_pip
...
> - ```Service Name```: etchubnetbh
> - ```Included Subnet Name```: etchubnetvn:AzureBastionSubnet
> - ```Sku```: Basic
