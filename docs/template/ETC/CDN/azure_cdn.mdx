...
- [**Azure CDN**](https://docs.cstudio.app/docs/resource/azure/Cdn/)
...
> - ```Network Rules.Name```: defaul_trule
...
> - ```Cdn Profile Location```: japaneast
