...
### 5. Subnet 생성
**Subnet** 아이콘을 가져옵니다. 
App Service가 사용하는 데이터가 Private 환경에 있다면 Subnet을 연결해야 Private 환경에 접근이 가능합니다.
Azure는 Subnet에 PaaS 서비스를 연결할 수 있는 Delegation 옵션이 있습니다.
캔버스에서 Linux Web App을 Subnet에 연결하면 Delegation 옵션을 설정할 수 있습니다. Linux App Service를 Subnet에 연결합니다.
...
Private Endpoint와 Mysql 데이터베이스를 연결합니다. 
