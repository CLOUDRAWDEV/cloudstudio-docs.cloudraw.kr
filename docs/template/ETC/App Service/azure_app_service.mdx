...
> - ```Service Name```: etc_appservice_nsg1
...
> - ```Service Name```: etc_appservice_nsg2
...
> - ```Service Name```: etc-appservice-mysql
> - ```Version```: 5.7
> - ```Sku Name```: GP_Gen5_4
> - ```Storage Mb```: 5120
...
> - ```Firewall Rule.StartIPAddress```: 0.0.0.0
...
> - ```Linked Connection Resource Name```: etc-appservice-mysql
