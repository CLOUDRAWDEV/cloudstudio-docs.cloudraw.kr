...
> - ```Credential Id```: AzureDevelopment
...
### 28. Security Center 생성
**Security Center** 아이콘을 가져옵니다.
Security Center는 다른 리소스의 취약점을 진단하고 해당 로그를 Log Analytics Workspace에 저장합니다.

> - ```Service Name```: lzsecurity

### 29. Virtual Network Peering 생성
