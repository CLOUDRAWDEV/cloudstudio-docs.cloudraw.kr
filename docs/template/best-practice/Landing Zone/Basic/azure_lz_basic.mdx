...
import azLandingZoneBasic1 from './img/azure-lz-basic/1.png';
import azLandingZoneBasic2 from './img/azure-lz-basic/2.png';
import azLandingZoneBasic3 from './img/azure-lz-basic/3.png';
import azLandingZoneBasic4 from './img/azure-lz-basic/4.png';
import azLandingZoneBasic5 from './img/azure-lz-basic/5.png';
import azLandingZoneBasic6 from './img/azure-lz-basic/6.png';
import azLandingZoneBasic7 from './img/azure-lz-basic/7.png';
import azLandingZoneBasic8 from './img/azure-lz-basic/8.png';
import azLandingZoneBasic9 from './img/azure-lz-basic/9.png';
import azLandingZoneBasic10 from './img/azure-lz-basic/10.png';
import azLandingZoneBasic11 from './img/azure-lz-basic/11.png';
...
Landing Zone은 각 회사에서 보안, 정책 관리, 접근 통제 등을 효과적으로 할 수 있는 아키텍처입니다.
...
<caption caption="[그림.1] Azure Landing Zone Basic 1" src={azLandingZoneBasic1} /><br/>
...
<caption caption="[그림.2] Azure Landing Zone Basic 2" src={azLandingZoneBasic2} /><br/>
...
<caption caption="[그림.3] Azure Landing Zone Basic 3" src={azLandingZoneBasic3} /><br/>
...
<caption caption="[그림.4] Azure Landing Zone Basic 4" src={azLandingZoneBasic4} /><br/>
...
<caption caption="[그림.5] Azure Landing Zone Basic 5" src={azLandingZoneBasic5} /><br/>
...
<caption caption="[그림.6] Azure Landing Zone Basic 6" src={azLandingZoneBasic6} /><br/>

### 7. 방화벽 생성
- CloudStudio에서는 방화벽을 서브넷과 합쳐서 제공합니다.
- 방화벽에서는 Network, Application, NAT 3가지 규칙을 제공합니다.
- 사용자 환경에 맞는 방화벽 규칙을 설정합니다. - 사용자 정의
<caption caption="[그림.7] Azure Landing Zone Basic 7" src={azLandingZoneBasic7} /><br/>
...
<caption caption="[그림.8] Azure Landing Zone Basic 8" src={azLandingZoneBasic8} /><br/>

### 9. Storage Account 생성
- Azure에서 제공하는 Object 스토리지 입니다.
- Storage Account은 Container, Queue, File, Table 4개 스토리지가 있습니다.
- 사용자는 필요한 유형의 스토리지를 생성 후 사용 가능합니다.
- Storage Account의 Network Rules에서는 Storage Account에 접근 가능한 접근 IP 통제를 지원합니다.
- 사용자의 Public IP만 접근 가능하도록 Network Rules을 설정합니다.
<caption caption="[그림.9] Azure Landing Zone Basic 9" src={azLandingZoneBasic9} /><br/>
...
<caption caption="[그림.10] Azure Landing Zone Basic 10" src={azLandingZoneBasic10} /><br/>

### 11. Automation Account 생성
...
<caption caption="[그림.11] Azure Landing Zone Basic 11" src={azLandingZoneBasic11} /><br/>
