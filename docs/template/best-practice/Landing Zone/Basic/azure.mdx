...
> - ```Service Name```: cloudraw_peering
> - ```Peering1.Name```: vnp253293-peering1
> - ```Peering1.Linked Vnet Name```: cloudraw:resourceGroup:hub_vnet
> - ```Traffic To Remote Vnet```: true
> - ```Traffic Forwarded From Remote Vnet```: false

<caption caption="[그림.14] Azure Landing Zone Basic 14" src={azure14} />

> - ```Peering2.Name```: vnp253293-peering2
> - ```Peering1.Linked Vnet Name```: cloudraw:resourceGroup:Application_vnet
> - ```Traffic To Remote Vnet```: true
> - ```Traffic Forwarded From Remote Vnet```: false
...
> - ```Network Rules.Name```: default_rule
...
> - ```Linked Connection Resource Name```: cloudrawsql
...
> - ```Included Subnet Name```: Application_vnet:ApplicationSubnet
> - ```Linked Connection Resource Name```: cloudraw
...
이 가이드에서는 Admin ID, SSH Public key를 사용해서 Virtual Machine을 배포합니다.
...
> - ```Sku```: Standard
> - ```Public Lb Frontend Ip Config.Name```: ipconfig
> - ```Public Lb Frontend Ip Config.Pip Name```: ipconfig-pip
...
> - ```Backend Address.name```: backendaddress
> - ```Backend Address.Virtual Network Name```: Application_vnet
> - ```Backend Address.Linked Virtual Machine Name```: ["ubuntuVm-nic-ipconfig:ubuntuVm"]

<caption caption="[그림.35] Azure Landing Zone Basic 35" src={azure35} />

> - ```Backend Pool.Name```: backendpool
> - ```Backend Pool.Backend Address Names```: backendaddress
